...
//     document.write("<br>")
//     document.write (num + " "+  "x" + " "+ 2 + " " + "="  , table2)
//     document.write("<br>")
//     document.write (num + " "+  "x" + " "+ 3 + " " + "="  , table3)
//     document.write("<br>")
//     document.write (num + " "+  "x" + " "+ 4 + " " + "="  , table4)
//     document.write("<br>")
//     document.write (num + " "+  "x" + " "+ 5 + " " + "="  , table5)
//     document.write("<br>")
//     document.write (num + " "+  "x" + " "+ 6 + " " + "="  , table6)
//     document.write("<br>")
//     document.write (num + " "+  "x" + " "+ 7 + " " + "="  , table7)
//     document.write("<br>")
//     document.write (num + " "+  "x" + " "+ 8 + " " + "="  , table8)
//     document.write("<br>")
//     document.write (num + " "+  "x" + " "+ 9 + " " + "="  , table9)
//     document.write("<br>")
//     document.write (num + " "+  "x" + " "+ 10 + " " + "="  , table10 )
//     document.write("<br>")
// }
// else{
//     var table1 = num * 1
...
// var maxAge = parseInt(prompt("Enter max age: "))
// var currentAge = parseInt(prompt("Enter your age: "))
...
// var chemMarks = parseFloat(prompt("Enter your marks in Chemistry: "))
// var physMarks = parseFloat(prompt("Enter your marks in Physics: "))
// var csMarks = parseFloat(prompt("Enter your marks in Computer: "))
// var total = 300
// var marksObtained = chemMarks + physMarks + csMarks
